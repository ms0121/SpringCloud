...
public class PaymentController {
    ...
    public CommonResult create(@RequestBody Payment payment) {
        ...
        log.info("**********插入的结果: " + i);
        if (i > 0) {
            return new CommonResult(200, "添加成功！port: " + serverPort, null);
        } else {
            return new CommonResult(404, "添加失败,请重试！", null);
        }
    }
    ...
    public String getServerPort(){
        return "当前的服务提供者的微服务端口号: " + serverPort;
    }
    ...
    public String getTimeout(){
        // 设置服务端处理业务花费3秒的时间，OpenFeign默认等待时间是1秒
        try {
